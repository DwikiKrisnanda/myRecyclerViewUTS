...
public class ListActivity extends RecyclerView.Adapter<ListActivity.ViewHolder> {
    ...
    public ListActivity(Context context, ArrayList<String> NamaPemain, ArrayList<String> LinkGambar, ArrayList<String> PosisiPemain, ArrayList<String> DetailPemain, ArrayList<String> NoPemain, ArrayList<String> UmurPemain, ArrayList<String> WargaNegaraPemain){
